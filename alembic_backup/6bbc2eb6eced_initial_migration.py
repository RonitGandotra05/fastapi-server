...
Revision ID: 6bbc2eb6eced
Revises: 
Create Date: 2024-11-01 14:17:34.113589
...
def upgrade() -> None:
    ...
    sa.Column('status', sa.Enum('assigned', 'resolved', name='bugstatus'), nullable=False),
